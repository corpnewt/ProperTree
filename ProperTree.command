...
class ProperTree:
    def __init__(self, plists = []):
        ...
        self.yes_no_check = tk.Checkbutton(self.settings_window,text="Use YES/NO instead of True/False for booleans.",variable=self.yes_no,command=self.yes_no_command)
        ...
        self.yes_no_check.grid(row=5,column=0,columnspan=2,sticky="w",padx=10)
    ...
    def yes_no_command(self, event = None):
        self.settings["yes_no"] = True if self.yes_no.get() == 1 else False
    ...
    def update_settings(self):
        ...
        self.yes_no.set(self.settings.get("yes_no",False))
